...
def inject_cpu_simulation_mocks():
    ...
    mock_triton.compiler.__path__ = ['triton.compiler']

    # Add triton.compiler.compiler mock
    mock_triton.compiler.compiler = MagicMock()
    mock_triton.compiler.compiler.__spec__ = MagicMock()
